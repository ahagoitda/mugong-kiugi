...
- 여성 캐릭터 중심의 높은 노출도 의상 (찢어진 로브, 깊은 네크라인, 하이슬릿 극대화)
- Blood Set 변형: 붉은 피/에너지, 찢어진 갑주풍 의상, 타락한 분위기
...
- `15plus_jeomsoyi.jpg` - 점소이 (여관/주점 NPC, 밝고 관능적인 tavern girl)

### Blood Set / 타락 15+ 버전 (8장 세트 테마)
...
- UI 팝업이나 이벤트 CG
- Android 앱 내 "비밀 도감" 또는 15+ 모드 잠금 해제 콘텐츠
...
- 추가 제작 필요 시: 남성 영웅 버전, 보스 여성 버전, 스킬 컷신, 배경 포함 합성 CG 등 요청
